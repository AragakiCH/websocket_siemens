// =========================================================================
// SelectorBaseDatos.tsx
// "Guardar en": en qué base de datos vive lo que edita esta pantalla.
//
// Nació dentro de Recetas y se sacó acá al aparecer la segunda pantalla que
// lo necesitaba (Alarmas). Es el mismo control con otros textos: lo único
// que cambia entre una y otra es QUÉ tablas se mueven, y eso es una frase,
...
// LO QUE NO ES
//
//   No es la base con la que se inició sesión: esa la elige el login. Es
//   dónde se leen y se guardan las tablas de ESTA pantalla, y vale para la
//   pantalla entera: una fila no puede apuntar a una base distinta de
//   aquella en la que está guardada.
// =========================================================================
import React, { useEffect, useMemo, useRef, useState } from 'react';
import { CheckIcon, ChevronDownIcon, DatabaseIcon } from 'lucide-react';
import type { BaseDatos } from '../../services/authApi';

export function SelectorBaseDatos({
  valor,
  bases,
  deshabilitado,
  onCambiar,
  ...
  /** Encabezado del desplegable: "Guardar las alarmas en". */
  titulo: string;
  /** `title` y `aria-label` del botón: qué se mueve al cambiarlo. */
  ayuda: string;
  /** Pie del desplegable: la aclaración que evita la duda más probable. */
