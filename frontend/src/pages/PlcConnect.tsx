// =========================================================================
// PlcConnect.tsx  —  ANTES era pages/Login.tsx
//
// ⚠️ PANTALLA DESCONECTADA DEL ROUTER. No la referencia nadie hoy.
//
// Esto NUNCA fue un login de usuarios: es el alta de un PLC (IP, marca y,
// para Rexroth, el descubrimiento de aplicaciones y programas del ctrlX).
// Cuando `/` pasó a ser el acceso real de Psi Core, este archivo se renombró
// para que el nombre dijera la verdad.
//
// Se conserva por una razón concreta: el flujo de DOS PASOS de Rexroth
// (fetchRexrothApps -> elegir app -> fetchRexrothPrograms) solo existe acá.
// `Configuracion.tsx` únicamente llama a fetchRexrothPrograms y obliga a
// escribir el nombre de la aplicación a mano. Si algún día se quiere ese
// selector en Configuración, el código a copiar está en este archivo.
//
// `POST /rexroth/apps` no tiene ningún otro consumidor en todo el frontend.
// =========================================================================
