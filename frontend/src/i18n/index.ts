...
const es: Dict = {
  ...
  'login.vendorAllenBradley': 'Allen-Bradley',
  'login.vendorAllenBradleyHint': 'ControlLogix · CompactLogix · Micro800 · EtherNet/IP, sin credenciales',
  'login.slot': 'Slot del procesador',
  'login.slotHint': '0 en CompactLogix y Micro800; en ControlLogix, el del módulo CPU en el chasis.',
  'login.identify': 'Identificar',
  'login.identifying': 'Identificando…',
  'login.vendorSiemensHint': 'S7-1500 · S7-1200 · S7-300/400 · OPC UA o S7comm',
  'login.s7Transport': 'Cómo conectar',
  'login.s7Opcua': 'OPC UA (4840)',
  'login.s7OpcuaHint': 'S7-1500, o S7-1200 con FW ≥ 4.4 y servidor OPC UA activado. Descubre los DB solo.',
  'login.s7comm': 'S7comm (102)',
  'login.s7commHint': 'S7-1200 sin OPC UA, S7-300/400. En TIA: "Permitir acceso PUT/GET" en la CPU y DB sin "Acceso optimizado". Los tags se escriben a mano.',
  'login.s7Rack': 'Rack',
  'login.s7Slot': 'Slot',
  'login.s7Import': 'Variables del PLC',
  'login.s7PasteTitle': 'Copia las variables desde TIA Portal',
  'login.s7PasteStep1': 'Abre el DB en TIA (doble clic en «Data_block_1»).',
  'login.s7PasteStep2': 'Clic en la primera variable, Ctrl+A y Ctrl+C.',
  'login.s7PasteStep3': 'Pega aquí con Ctrl+V. La app saca nombres, tipos y direcciones sola.',
  'login.s7PastePlaceholder': 'Pega aquí las filas copiadas del DB…',
  'login.s7PasteRead': 'Leer variables',
  'login.s7ImportDrop': 'O arrastra aquí ficheros .db de TIA («Generate source from blocks»)',
  'login.s7ImportHow': 'Un S7-1200 no puede decir los nombres de sus variables por S7comm: están en el proyecto de TIA. Por eso se copian de allí; después la app las lee sola del PLC.',
  'login.s7Importing': 'Leyendo variables…',
  'login.s7Manual': 'Escribir la lista a mano',
  'login.s7DbNumber': 'DB nº',
  'login.s7Tags': 'Tags a leer (uno por línea: nombre;DB;offset;TIPO)',
  'login.s7TagsHint': 'El offset sale de la columna «Offset» del DB en TIA. Tipos: BOOL (offset con bit, 4.0), INT, DINT, REAL, LREAL, STRING[n], WORD, DWORD, BYTE…',
  'login.needTags': 'Sube los ficheros .db de TIA (o escribe la lista a mano) y marca al menos una variable.',
  'login.vendorRexrothHint': 'ctrlX CORE · Data Layer (HTTPS) · Usuario y contraseña',
...
const en: Dict = {
  ...
  'login.vendorRexroth': 'Rexroth',
  'login.vendorAllenBradley': 'Allen-Bradley',
  'login.vendorAllenBradleyHint': 'ControlLogix · CompactLogix · Micro800 · EtherNet/IP, no credentials',
  'login.slot': 'Processor slot',
  'login.slotHint': '0 on CompactLogix and Micro800; on ControlLogix, the CPU module slot.',
  'login.identify': 'Identify',
  'login.identifying': 'Identifying…',
  'login.vendorSiemensHint': 'S7-1500 · S7-1200 · S7-300/400 · OPC UA or S7comm',
  'login.s7Transport': 'How to connect',
  'login.s7Opcua': 'OPC UA (4840)',
  'login.s7OpcuaHint': 'S7-1500, or S7-1200 with FW ≥ 4.4 and the OPC UA server enabled. Discovers DBs by itself.',
  'login.s7comm': 'S7comm (102)',
  'login.s7commHint': 'S7-1200 without OPC UA, S7-300/400. In TIA: allow PUT/GET on the CPU and DBs without "Optimized block access". Tags are typed by hand.',
  'login.s7Rack': 'Rack',
  'login.s7Slot': 'Slot',
  'login.s7Import': 'PLC variables',
  'login.s7PasteTitle': 'Copy the variables from TIA Portal',
  'login.s7PasteStep1': 'Open the DB in TIA (double-click "Data_block_1").',
  'login.s7PasteStep2': 'Click the first variable, Ctrl+A and Ctrl+C.',
  'login.s7PasteStep3': 'Paste here with Ctrl+V. The app extracts names, types and addresses by itself.',
  'login.s7PastePlaceholder': 'Paste the copied DB rows here…',
  'login.s7PasteRead': 'Read variables',
  'login.s7ImportDrop': 'Or drop here .db files from TIA ("Generate source from blocks")',
  'login.s7ImportHow': 'An S7-1200 cannot tell its variable names over S7comm: they live in the TIA project. That is why they are copied from there; afterwards the app reads them from the PLC on its own.',
  'login.s7Importing': 'Reading variables…',
  'login.s7Manual': 'Type the list by hand',
  'login.s7DbNumber': 'DB no.',
  'login.s7Tags': 'Tags to read (one per line: name;DB;offset;TYPE)',
  'login.s7TagsHint': 'Offsets come from the "Offset" column of the DB in TIA. Types: BOOL (offset with bit, 4.0), INT, DINT, REAL, LREAL, STRING[n], WORD, DWORD, BYTE…',
  'login.needTags': 'Upload the TIA .db files (or type the list by hand) and tick at least one variable.',
  'login.vendorRexrothHint': 'ctrlX CORE · Data Layer (HTTPS) · Username and password',
